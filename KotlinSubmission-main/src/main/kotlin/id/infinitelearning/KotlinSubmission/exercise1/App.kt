 ...
 */
fun myProfile(firstname: String, lastName: String, age: Int, isSingle: Boolean) {
    val firstName: String = "Annisyah Ariesa"
    val lastName: String = "Zahra"
    val age: Int = 21
...
fun groupDetail(groupId: Int, groupMember: List<Any>, session: String): Any {
    val groupId: Int ="5"
    val groupMember: List<Any> =listOf("Angela", 21, true, "Lizzam", 20, false)
    val session: String = "Afternoon"
 ...
 */
fun myGroup(): String {
    val groupMember: List<String> = listOf("Haikal", "Angela", "Devita", "Annisyah", "Ahmad")
    return "Annisyah"
...
fun main() {
     ...
     *
     */
    groupDetail(5, listOf("Haikal", "Angela", "Devita","Annisyah","Ahmad"), "Afternoon")
